...
function Home() {
  ...
  // Lógica de manejo de carga y errores
  if (loading) {
    return <p>Cargando...</p>;
  }
    ...
    <>
      ...
      {auth.role === "Admin" && (
        <div className="command mt-8">
          ...
          {isModalMenuOpen && <ModalMenu closeMenuModal={closeMenuModal} />}
        </div>
      )}
      ...
      <div className="container-command">
        ...
        <div className="command mt-8 mb-6 text-center">
...
// function Home() {
//   const { auth, loading, forceUpdate } = useAuth();
//   // ... (resto del código)

//   useEffect(() => {
//     forceUpdate(); // Forzar actualización cuando cambie auth
//   }, [auth]);
